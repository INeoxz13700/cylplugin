...
public class Policier extends Missions implements Legal, Security, Radio, Near, EnfoncerPorte {
    public static Grades grades = new Grades("policier");

    public static JobGradeTresorerie tresorerie = new JobGradeTresorerie("policier");
    ...
    public Policier(String player) {
        ...
        Interact interaction = InteractBuilder.build().interact(Jobs.TypeInteract.ENTITY).entity(EntityType.PLAYER).priority(2).item(Action.AMENDE.getItem()).item(Action.MENOTTER.getItem()).item(Action.DEMENOTTER.getItem()).item(Action.FOUILLER.getItem()).item(Action.WANTED.getItem()).create();
        ...
        Interact interaction3 = InteractBuilder.build().interact(Jobs.TypeInteract.ENTITY).entity(EntityType.PLAYER).job(Jobs.Job.TERRORISTE).priority(3).item(Action.RANCON.getItem()).item(Action.MENOTTER.getItem()).item(Action.DEMENOTTER.getItem()).item(Action.FOUILLER.getItem()).item(Action.AMENDE.getItem()).item(Action.WANTED.getItem()).create();
    ...
    public static void loadJobData() {
        ...
        tresorerie.loadData();
        Jobs.Job.POLICIER.loadJobClothes();
    }
